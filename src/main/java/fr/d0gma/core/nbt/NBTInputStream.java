package fr.d0gma.core.nbt;

import fr.d0gma.core.nbt.exception.NBTParseException;
...
public class NBTInputStream extends DataInputStream {
     ...
     * @param internNames  Whether {@link #readCompound()} will use interned tag names
     * @param internValues Whether {@link #readValue(TagType) readValue()} will intern {@link
    ...
    public NBTCompound readFully() throws IOException {
        ...
        readString(); // Skip root name; typically empty anyway.
        return readCompound();
    }
    ...
    public Object readValue(TagType tagType) throws IOException {
        return switch (tagType) {
            ...
            case STRING -> readString(internValues);
            case LIST -> readList();
