...
public final class StringValue extends Value<String> implements IStringValue {
    ...
    public StringValue(String nameKey, String descriptionKey, String defaultValue, int minLength, int maxLength) {
